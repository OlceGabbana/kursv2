...
<body>
        ...
        <div class="modal_content">
            ...
            <div class="foot_modal">
                ...
                <div class="foot_modal_form">
                    ...
                    else echo '<button id="checkout_button" class="checkout_button" onclick="swalfunc();" name="checkout_button">Оформить заказ</button>';
                    ?>
                </div>
            </div>
        </div>
    ...
    <div class='shopping_busket'>
        <div id="openModalBtn_order" onclick="" class='shopping_busket_back'>
            <div id="allsum1"></div>
